...
insert into `subject` (id, title)
		values (1, 'Sports'), (2, 'Cooking'), (3, 'Biography'), (4, 'Comedy'), (5, 'Drama');

insert into `format` (id, title)
		values (10, 'DVD'), (20, 'Streaming'), (30, 'Cassette');

insert into `rating` (id, title)
		values (100, 'NR'), (200, 'G'), (300, 'PG-13'), (400, 'R');
        
insert into `author`(id, firstName, lastName)
values(101, 'Gary', 'Gramling'), (201,'Tim', 'Grover'), (301, 'David', 'Chang'), (401, 'Samin', 'Nosrat'), (501, 'Qian Julie', 'Wang');

insert into `publisher`(id, publisher)
values(102, 'Time Home Entertainment Incorporated'), (202,'Scribner'), (302, 'Clarkson Potter/Ten Speed'), (402, 'Simon & Schuster'), (502, 'Knopf Doubleday Publishing Group');

insert into book (title, summary, author_id, subject_id, publisher_id, year_published)
values 
 ...
 insert into movie (title, format_id, year_released, `4k`, `HD`, rating_id, subject_id)
 values
 		('Boston\'s Greatest Sports Stories', '10', '2004', 'N', 'N', '100', 1),
        ('Cars', 10, '2006', 'N', 'Y', '200', 4),
        ('The robber', '20', '2014', 'N', 'Y', '100', '5'),
        ('Any Given Sunday','30','2000','N','N','400','5'),
        ('Muhammad Ali','20','2015','N','Y','200','3');
